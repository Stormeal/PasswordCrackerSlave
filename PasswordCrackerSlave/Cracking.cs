...
namespace PasswordCrackerCentralized
{
    public class Cracking
    {
        ...
        public void RunCracking()
        {
            ...
            int index = Slave.Indexer;
            for (int i = 0; i < 5000; i++)
            {
                //Console.WriteLine(Slave.DictList[index]);
                IEnumerable<UserInfoClearText> partialResult = CheckWordWithVariations(Slave.DictList[index], Slave.UserList);
                Slave.ResultList.Add(partialResult.ToString());
            ...
            //        IEnumerable<UserInfoClearText> partialResult = CheckWordWithVariations(dictionaryEntry, Slave.UserList);
            ...
            //Console.WriteLine("Out of {0} password {1} was found ", Slave.UserList.Count, result.Count);
            //Console.WriteLine();
